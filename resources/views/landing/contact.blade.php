...
@section('body')
    <!-- Section: About -->
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="{{ asset('assets/images/bg/bg6.jpg') }}" style="background-image: url(&quot;images/bg/bg6.jpg&quot;); background-position: 50% 89px;">
          ...
          <div class="row pt-30">
            <div class="col-md-4">
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-12">
                  <div class="icon-box left media bg-deep p-30 mb-20"> <a class="media-left pull-left" href="#"> <i class="pe-facebook text-theme-colored"></i></a>
            ...
            <div class="col-md-8">
              ...
              <!-- Contact Form -->
              <form id="contact_form" name="contact_form" class="" action="http://html.kodesolution.live/s/workshop/v3.0/demo/includes/sendmail.php" method="post" novalidate="novalidate">
