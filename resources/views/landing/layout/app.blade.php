                                                    ...
                                                    <div class="dropdown-cart">
                                                        <table class="table cart-table-list table-responsive">
                                                            <tbody>
                                                                <tr>
                                                                    <td><a href="#"><img alt=""
                                                                                src="{{ asset('assets/images/products/sm1.jpg') }}"></a>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td><a href="#"><img alt=""
                                                                                src="{{ asset('assets/images/products/sm2.jpg') }}"></a>
                                                                    </td>
                                                                    <td><a href="#"> Product Title</a></td>
                                                                    <td>X2</td>
                                                                    <td>$ 70.00</td>
                                ...
                                <li class="active"><a href="#home">Home</a>
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="#">Boxed Layouts</a>
                                            <ul class="dropdown">
                                                <li><a href="index-boxed-mp-layout1.html">Boxed Multi Page Layout1</a>
                                                </li>
                                                <li><a href="index-boxed-mp-layout2.html">Boxed Multi Page Layout2</a>
                                                </li>
                                                <li><a href="index-boxed-mp-layout3.html">Boxed Multi Page Layout3</a>
                                                </li>
                                                <li><a href="index-boxed-mp-layout4.html">Boxed Multi Page Layout4</a>
                                                </li>
                                                <li><a href="index-boxed-mp-layout5.html">Boxed Multi Page Layout5</a>
                                                </li>
                                                <li><a href="index-boxed-sp-layout1.html">Boxed Single Page Layout1</a>
                                                </li>
                                                <li><a href="index-boxed-sp-layout2.html">Boxed Single Page Layout2</a>
                                                </li>
                                                <li><a href="index-boxed-sp-layout3.html">Boxed Single Page Layout3</a>
                                                </li>
                                                <li><a href="index-boxed-sp-layout4.html">Boxed Single Page Layout4</a>
                                                </li>
                                                <li><a href="index-boxed-sp-layout5.html">Boxed Single Page Layout5</a>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li><a href="#">Dark Layouts</a>
                                            <ul class="dropdown">
                                                <li><a href="index-dark-mp-layout1.html">Dark Multi Page Layout1</a>
                                                </li>
                                                <li><a href="index-dark-mp-layout2.html">Dark Multi Page Layout2</a>
                                                </li>
                                                <li><a href="index-dark-mp-layout3.html">Dark Multi Page Layout3</a>
                                                </li>
                                                <li><a href="index-dark-mp-layout4.html">Dark Multi Page Layout4</a>
                                                </li>
                                                <li><a href="index-dark-mp-layout5.html">Dark Multi Page Layout5</a>
                                                </li>
                                                <li><a href="index-dark-sp-layout1.html">Dark Single Page Layout1</a>
                                                </li>
                                                <li><a href="index-dark-sp-layout2.html">Dark Single Page Layout2</a>
                                                </li>
                                                <li><a href="index-dark-sp-layout3.html">Dark Single Page Layout3</a>
                                                </li>
                                                <li><a href="index-dark-sp-layout4.html">Dark Single Page Layout4</a>
                                                </li>
                                                <li><a href="index-dark-sp-layout5.html">Dark Single Page Layout5</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li><a href="#">Magazine Home Layouts</a>
                                            <ul class="dropdown">
                                                ...
                                                <li><a href="index-magazine-home-layout2.html">Magazine Home layout2</a>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li><a href="#">Hot Layouts</a>
                                            <ul class="dropdown">
                                                <li><a href="index-split-slider-home.html">Split Slider Home Layout</a>
                                                </li>
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="#">Page Title</a>
                                            <ul class="dropdown">
                                                ...
                                                <li><a href="features-page-title-mini-version.html">Mini Version</a>
                                                </li>
                                        ...
                                        <li><a href="#">Side Push Panel</a>
                                            <ul class="dropdown">
                                                <li><a href="features-side-push-panel-left-overlay.html">Left
                                                        Overlay</a></li>
                                                <li><a href="features-side-push-panel-left-push.html">Left Push</a></li>
                                                <li><a href="features-side-push-panel-right-overlay.html">Right
                                                        Overlay</a></li>
                                                <li><a href="features-side-push-panel-right-push.html">Right Push</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li><a href="#">Sliders</a>
                                            <ul class="dropdown">
                                                ...
                                                <li><a href="features-home-bg-image-slider.html">Bg Image Slider</a>
                                                </li>
                                                <li><a href="features-home-owl-fullwidth-carousel.html">Owl Fullwidth
                                                        Carousel</a></li>
                                                <li><a href="features-home-parallax-bg.html">Static/Parallax Image
                                                        Bg</a></li>
                                            ...
                                            <ul class="dropdown">
                                                <li><a href="#">Login/Register Form</a>
                                                    <ul class="dropdown">
                                                        ...
                                                        <li><a href="#">Login</a>
                                                            <ul class="dropdown">
                                                                <li><a href="form-login-style1.html">Form style 1</a>
                                                                </li>
                                                                <li><a href="form-login-style2.html">Form style 2</a>
                                                                </li>
                                                                <li><a href="form-login-style3.html">Form style 3</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                ...
                                                <li><a href="#">Quick Contact Form</a>
                                                    <ul class="dropdown">
                                                        <li><a href="form-quick-contact-style1.html">Form style 1</a>
                                                        </li>
                                                        <li><a href="form-quick-contact-style2.html">Form style 2</a>
                                                        </li>
                                                        <li><a href="form-quick-contact-style3.html">Form style 3</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        ...
                                        <li><a href="#">Paypal Form</a>
                                            <ul class="dropdown">
                                                <li><a href="#">Donation Onetime</a>
                                                    <ul class="dropdown">
                                                        <li><a href="form-paypal-donate-onetime-style1.html">Style1</a>
                                                        </li>
                                                        <li><a href="form-paypal-donate-onetime-style2.html">Style2</a>
                                                        </li>
                                                        <li><a href="form-paypal-donate-onetime-style3.html">Style3</a>
                                                        </li>
                                                        <li><a href="form-paypal-donate-onetime-style4.html">Style4</a>
                                                        </li>
                                                        <li><a href="form-paypal-donate-onetime-style5.html">Style5</a>
                                                        </li>
                                                        <li><a href="form-paypal-donate-onetime-style6.html">Style6</a>
                                                        </li>
                                                        <li><a href="form-paypal-donate-onetime-style7.html">Style7</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li><a href="#">Donation Recurring</a>
                                                    <ul class="dropdown">
                                                        ...
                                                        <li><a href="form-paypal-donate-recurring-style2.html">
                                                                Style2</a></li>
                                                        <li><a
                                                ...
                                                <li><a href="form-paypal-order-style1.html">Order Payment Style1</a>
                                                </li>
                                                <li><a href="form-paypal-order-style2.html">Order Payment Style2</a>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li><a href="#">Footer</a>
                                            <ul class="dropdown">
                                                <li><a href="features-footer-style1.html#footer">Footer Dark One</a>
                                                </li>
                                                <li><a href="features-footer-style2.html#footer">Footer Dark Two</a>
                                                </li>
                                                <li><a href="features-footer-style3.html#footer">Footer Dark Three</a>
                                                </li>
                                                <li><a href="features-footer-style4.html#footer">Footer Dark Four</a>
                                                </li>
                                                <li><a href="features-footer-style5.html#footer">Footer Dark Five</a>
                                                </li>
                                                <li><a href="features-footer-style6.html#footer">Footer Dark Six</a>
                                                </li>
                                                <li><a href="features-footer-style7.html#footer">Footer Dark Seven</a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="#">Gallery</a>
                                            <ul class="dropdown">
                                                ...
                                                <li><a href="page-gallery-3col-only-image.html">3 Columns Only Image</a>
                                                </li>
                                                <li><a href="page-gallery-4col-only-image.html">4 Columns Only Image</a>
                                                </li>
                                                <li><a href="page-gallery-grid.html">Grids (2-10 Columns)</a></li>
                                                <li><a href="page-gallery-grid-animation.html">Grids with Animation
                                                        (2-10 Columns)</a></li>
                                                <li><a href="page-gallery-masonry-tiles.html">Tiles (2-10 Columns)</a>
                                                </li>
                                                <li><a href="page-gallery-masonry-tiles-animation.html">Tiles with
                                                        Animation (2-10 Columns)</a></li>
                                                <li><a href="page-gallery-prettyphoto.html">Pretty Photo Gallery</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li><a href="#">Pricing</a>
                                        ...
                                        <li><a href="#">Contact</a>
                                            <ul class="dropdown">
                                                ...
                                                <li><a href="page-contact5-with-multiple-marker.html">Contact 5 -
                                                        Multiple Marker</a></li>
                                                <li><a href="page-contact6-with-multiple-marker.html">Contact 6 -
                                                        Multiple Marker</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="#">FAQ</a>
                                    ...
                                    <ul class="dropdown">
                                        <li><a href="#">Boxed</a>
                                            <ul class="dropdown">
                                                <li><a href="#">Gutter</a>
                                                    <ul class="dropdown">
                                                        <li><a href="portfolio-boxed-gutter-1-col.html">1 Column</a>
                                                        </li>
                                                        <li><a href="portfolio-boxed-gutter-2-col.html">2 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-boxed-gutter-3-col.html">3 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-boxed-gutter-4-col.html">4 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-boxed-gutter-5-col.html">5 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-boxed-gutter-6-col.html">6 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-boxed-gutter-7-col.html">7 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-boxed-gutter-8-col.html">8 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-boxed-gutter-9-col.html">9 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-boxed-gutter-10-col.html">10 Columns</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                ...
                                                <li><a href="#">Title - Gutter Less</a>
                                                    <ul class="dropdown">
                                                        ...
                                                        <li><a href="portfolio-boxed-title-2-col.html">2 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-boxed-title-3-col.html">3 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-boxed-title-4-col.html">4 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-boxed-title-5-col.html">5 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-boxed-title-6-col.html">6 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-boxed-title-7-col.html">7 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-boxed-title-8-col.html">8 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-boxed-title-9-col.html">9 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-boxed-title-10-col.html">10 Columns</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                                            ...
                                            <ul class="dropdown">
                                                <li><a href="#">Gutter</a>
                                                    <ul class="dropdown">
                                                        ...
                                                        <li><a href="portfolio-wide-gutter-2-col.html">2 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-wide-gutter-3-col.html">3 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-wide-gutter-4-col.html">4 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-wide-gutter-5-col.html">5 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-wide-gutter-6-col.html">6 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-wide-gutter-7-col.html">7 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-wide-gutter-8-col.html">8 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-wide-gutter-9-col.html">9 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-wide-gutter-10-col.html">10 Columns</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li><a href="#">Gutter Less</a>
                                                ...
                                                <li><a href="#">Title - Gutter Less</a>
                                                    <ul class="dropdown">
                                                        ...
                                                        <li><a href="portfolio-wide-title-10-col.html">10 Columns</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        ...
                                        <li><a href="#">Masonry Boxed</a>
                                            <ul class="dropdown">
                                                ...
                                                <li><a href="#">Gutter Less</a>
                                                    <ul class="dropdown">
                                                        <li><a href="portfolio-masonry-boxed-2-col.html">2 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-masonry-boxed-3-col.html">3 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-masonry-boxed-4-col.html">4 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-masonry-boxed-5-col.html">5 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-masonry-boxed-6-col.html">6 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-masonry-boxed-7-col.html">7 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-masonry-boxed-8-col.html">8 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-masonry-boxed-9-col.html">9 Columns</a>
                                                        </li>
                                                ...
                                                <li><a href="#">Title - Gutter Less</a>
                                                    <ul class="dropdown">
                                                        <li><a href="portfolio-masonry-boxed-title-2-col.html">2
                                                                Columns</a></li>
                                                        <li><a href="portfolio-masonry-boxed-title-3-col.html">3
                                                                Columns</a></li>
                                                        <li><a href="portfolio-masonry-boxed-title-4-col.html">4
                                                                Columns</a></li>
                                                        <li><a href="portfolio-masonry-boxed-title-5-col.html">5
                                                                Columns</a></li>
                                                        <li><a href="portfolio-masonry-boxed-title-6-col.html">6
                                                                Columns</a></li>
                                                        <li><a href="portfolio-masonry-boxed-title-7-col.html">7
                                                                Columns</a></li>
                                                        <li><a href="portfolio-masonry-boxed-title-8-col.html">8
                                                                Columns</a></li>
                                                        <li><a href="portfolio-masonry-boxed-title-9-col.html">9
                                                                Columns</a></li>
                                        ...
                                        <li><a href="#">Masonry Wide</a>
                                            <ul class="dropdown">
                                                <li><a href="#">Gutter</a>
                                                    <ul class="dropdown">
                                                        <li><a href="portfolio-masonry-wide-gutter-2-col.html">2
                                                                Columns</a></li>
                                                        <li><a href="portfolio-masonry-wide-gutter-3-col.html">3
                                                                Columns</a></li>
                                                        <li><a href="portfolio-masonry-wide-gutter-4-col.html">4
                                                                Columns</a></li>
                                                        <li><a href="portfolio-masonry-wide-gutter-5-col.html">5
                                                                Columns</a></li>
                                                        <li><a href="portfolio-masonry-wide-gutter-6-col.html">6
                                                                Columns</a></li>
                                                        <li><a href="portfolio-masonry-wide-gutter-7-col.html">7
                                                                Columns</a></li>
                                                        <li><a href="portfolio-masonry-wide-gutter-8-col.html">8
                                                                Columns</a></li>
                                                        <li><a href="portfolio-masonry-wide-gutter-9-col.html">9
                                                                Columns</a></li>
                                                ...
                                                <li><a href="#">Gutter Less</a>
                                                    <ul class="dropdown">
                                                        <li><a href="portfolio-masonry-wide-2-col.html">2 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-masonry-wide-3-col.html">3 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-masonry-wide-4-col.html">4 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-masonry-wide-5-col.html">5 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-masonry-wide-6-col.html">6 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-masonry-wide-7-col.html">7 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-masonry-wide-8-col.html">8 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-masonry-wide-9-col.html">9 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-masonry-wide-10-col.html">10 Columns</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                        ...
                                        <li><a href="#">Tiles Boxed</a>
                                            <ul class="dropdown">
                                                ...
                                                <li><a href="#">Gutter Less</a>
                                                    <ul class="dropdown">
                                                        <li><a href="portfolio-tiles-boxed-2-col.html">2 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-tiles-boxed-3-col.html">3 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-tiles-boxed-4-col.html">4 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-tiles-boxed-5-col.html">5 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-tiles-boxed-6-col.html">6 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-tiles-boxed-7-col.html">7 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-tiles-boxed-8-col.html">8 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-tiles-boxed-9-col.html">9 Columns</a>
                                                        </li>
                                                        <li><a href="portfolio-tiles-boxed-10-col.html">10 Columns</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li><a href="#">Title - Gutter</a>
                                            ...
                                            <ul class="dropdown">
                                                ...
                                                <li><a href="#">Gutter Less</a>
                                                    <ul class="dropdown">
                                                        ...
                                                        <li><a href="portfolio-tiles-wide-10-col.html">10 Columns</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li><a href="#">Title - Gutter</a>
                                        ...
                                        <li><a href="#">Loading Styles</a>
                                            <ul class="dropdown">
                                                <li><a href="portfolio-extra-infinity-scroll.html">Infinity Scroll</a>
                                                </li>
                                                <li><a href="portfolio-extra-infinity-scroll-lazyload.html">Infinity
                                        ...
                                        <li><a href="#">Single</a>
                                            <ul class="dropdown">
                                                ...
                                                <li><a href="portfolio-details-image-gallery.html">With - Image
                                                        Gallery</a></li>
                                                <li><a href="portfolio-details-video-gallery.html">With - Video
                                                        Gallery</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                        ...
                                        <div class="megamenu-row">
                                            <div class="col3">
                                                <ul class="list-unstyled list-dashed">
                                                    ...
                                                    <li><a href="shortcode-button-hover-effect.html"><i
                                                                class="fa fa-flag-o"></i> Button Hover Effect</a>
                                                    </li>
                                            ...
                                            <div class="col3">
                                                <ul class="list-unstyled list-dashed">
                                                    ...
                                                    <li><a href="shortcode-iconbox.html"><i class="fa fa-unsorted"></i>
                                                            Icon Box</a></li>
                        ...
                        <div class="rev_slider" data-version="5.0">
                            <ul>
                                ...
                                <li data-index="rs-1" data-transition="slidingoverlayhorizontal"
                                    ...
                                    data-masterspeed="default" data-thumb="{{ asset('assets/images/bg/bg21.jpg') }}"
                                    data-rotate="0" data-saveperformance="off" data-title="Slide 1" data-description="">
                                    <!-- MAIN IMAGE -->
                                    <img src="{{ asset('assets/images/bg/bg21.jpg') }}" alt=""
                                    ...
                                    <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway"
                                        ...
                                        data-voffset="['-110']" data-fontsize="['90']" data-lineheight="['110']"
                                        ...
                                        style="z-index: 7; white-space: nowrap; font-weight:700;">Workshop
                                    </div>
                                    ...
                                    <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway bg-theme-colored-transparent border-left-theme-color-2-6px pl-20 pr-20"
                                        ...
                                        data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="1000"
                                        data-splitin="none" data-splitout="none" data-responsive_offset="on"
                                        style="z-index: 7; white-space: nowrap; font-weight:600;">The Best Car Workshop
                                    </div>
                                ...
                                <li data-index="rs-2" data-transition="slidingoverlayhorizontal"
                                    data-slotamount="default" data-easein="default" data-easeout="default"
                                    data-masterspeed="default" data-thumb="{{ asset('assets/images/bg/bg22.jpg') }}"
                                    data-rotate="0" data-saveperformance="off" data-title="Slide 2" data-description="">
                                    <!-- MAIN IMAGE -->
                                    <img src="{{ asset('assets/images/bg/bg22.jpg') }}" alt=""
                                    ...
                                    <div class="tp-caption tp-resizeme text-white text-center" id="rs-2-layer-3"
                                        ...
                                        data-voffset="['50']" data-fontsize="['16','18',24']" data-lineheight="['28']"
                                        data-width="none" data-height="none" data-whitespace="nowrap"
                                        data-transform_idle="o:1;s:500"
                                        data-transform_in="y:100;scaleX:1;scaleY:1;opacity:0;"
                                        data-transform_out="x:left(R);s:1000;e:Power3.easeIn;s:1000;e:Power3.easeIn;"
                                ...
                                <li data-index="rs-3" data-transition="slidingoverlayhorizontal"
                                    data-slotamount="default" data-easein="default" data-easeout="default"
                                    data-masterspeed="default" data-thumb="{{ asset('assets/images/bg/bg23.jpg') }}"
                                    data-rotate="0" data-saveperformance="off" data-title="Slide 3" data-description="">
                                    <!-- MAIN IMAGE -->
                                    <img src="{{ asset('assets/images/bg/bg23.jpg') }}" alt=""
                    ...
                    <div class="section-content">
                        <div class="row">
                            <div class="col-sm-6 col-md-4 maxwidth500 mb-sm-40 wow fadeInUp" data-margin-top="-140px"
                                ...
                                <img class="img-fullwidth" src="{{ asset('assets/images/about/1.jpg') }}" alt="">
                                <div class="bg-lighter border-1px p-20 pt-0 mb-sm-180">
                                    <h4 class="font-weight-700 mt-20">Experienced Service</h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero omnis unde
                                        nesciunt?</p>
                            ...
                            <div class="col-sm-6 col-md-4 maxwidth500 mb-sm-40 wow fadeInUp" data-margin-top="-140px"
                                data-wow-duration="1s" data-wow-delay="0.1s">
                                <img class="img-fullwidth" src="{{ asset('assets/images/about/2.jpg') }}" alt="">
                                <div class="bg-lighter border-1px p-20 pt-0 mb-sm-180">
                                    <h4 class="font-weight-700 mt-20">Wheel & Tire Repairing</h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero omnis unde
                                        nesciunt?</p>
                                    <a href="#" class="btn btn-sm btn-theme-colored">Read more</a>
                                </div>
                            ...
                            <div class="col-sm-6 col-md-4 maxwidth500 mb-sm-0 wow fadeInUp" data-margin-top="-140px"
                                data-wow-duration="1s" data-wow-delay="0.1s">
                                <img class="img-fullwidth" src="{{ asset('assets/images/about/3.jpg') }}" alt="">
                                <div class="bg-lighter border-1px p-20 pt-0">
                                    <h4 class="font-weight-700 mt-20">Car Body Repairing</h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero omnis unde
                                        nesciunt?</p>
                                    <a href="#" class="btn btn-sm btn-theme-colored">Read more</a>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
                                <h2 class="text-uppercase mt-0 font-weight-600">Welcome To <span
                                        class="text-theme-color-2">Workshop</span><br> HTML5 Tempalte</h2>
                                <h4 class="text-gray-dimgray font-weight-400"><em>Lorem ipsum dolor sit amet,
                                        consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore.</em>
                                </h4>
                                <p>Sit amet consectetur adipisicing elit. Aliquid iste iusto reiciendis praesentium
                                    dolorem doloribus nisi architecto voluptatibus explicabo, possimus ullam quae illum
                                    maiores aperiam consequuntur.</p>
                                <p>Sit amet consectetur adipisicing elit. Aliquid iste iusto reiciendis praesentium
                                    dolorem doloribus nisi architecto voluptatibus explicabo, possimus ullam quae illum
                                    maiores aperiam consequuntur facere similique voluptatum.</p>
                                <a href="#"
                            ...
                            <div class="col-md-6 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
                                <div class="row mb-10">
                                    <div class="col-md-12">
                                        <img class="img-fullwidth" src="{{ asset('assets/images/about/ab1.jpg') }}"
                                            alt="">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 pr-5 pr-sm-15 mb-sm-10">
                                        <img class="img-fullwidth" src="{{ asset('assets/images/about/ab2.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="col-md-6 pl-5 pl-sm-15">
                                        <img class="img-fullwidth" src="{{ asset('assets/images/about/ab3.jpg') }}"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-4">
                                <div class="icon-box p-10 pl-20 pr-15 mb-20 bg-white">
                                    ...
                                    <h3 class="icon-box-title mt-10 mb-10">Wash and Glassing</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia quasi qui
                                        inventore, cumque!<a href="#" class="btn-read-more text-theme-colored"> Read
                                            more</a></p>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-4">
                                <div class="icon-box p-10 pl-20 pr-15 mb-20 bg-white">
                                    <a class="mb-0 line-bottom" href="#">
                                        <i class="flaticon-carrepair-tool-7 text-theme-colored"></i>
                                    </a>
                                    <h3 class="icon-box-title mt-10 mb-10">Engine Diognostic</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia quasi qui
                                        inventore, cumque!<a href="#" class="btn-read-more text-theme-colored"> Read
                                            more</a></p>
                                </div>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="icon-box p-10 pl-20 pr-15 mb-20 bg-white">
                                    <a class="mb-0 line-bottom" href="#">
                                        <i class="flaticon-carrepair-tool-4 text-theme-colored"></i>
                                    </a>
                                    <h3 class="icon-box-title mt-10 mb-10">Security inspection</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia quasi qui
                                        inventore, cumque!<a href="#" class="btn-read-more text-theme-colored"> Read
                                            more</a></p>
                                </div>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="icon-box p-10 pl-20 pr-15 mb-sm-20 bg-white">
                                    <a class="mb-0 line-bottom" href="#">
                                        <i class="flaticon-carrepair-pistons-cross text-theme-colored"></i>
                                    </a>
                                    <h3 class="icon-box-title mt-10 mb-10">Car Body Repairing</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia quasi qui
                                        inventore, cumque!<a href="#" class="btn-read-more text-theme-colored"> Read
                                            more</a></p>
                                </div>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="icon-box p-10 pl-20 pr-15 mb-sm-20 bg-white">
                                    <a class="mb-0 line-bottom" href="#">
                                        <i class="flaticon-carrepair-transport-6 text-theme-colored"></i>
                                    </a>
                                    <h3 class="icon-box-title mt-10 mb-10">Complete Analysis</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia quasi qui
                                        inventore, cumque!<a href="#" class="btn-read-more text-theme-colored"> Read
                                            more</a></p>
                                </div>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="icon-box p-10 pl-20 pr-15 bg-white">
                                    <a class="mb-0 line-bottom" href="#">
                                        <i class="flaticon-carrepair-transport-7 text-theme-colored"></i>
                                    </a>
                                    <h3 class="icon-box-title mt-10 mb-10">Schedule Services</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia quasi qui
                                        inventore, cumque!<a href="#" class="btn-read-more text-theme-colored"> Read
                                            more</a></p>
                                </div>
                    ...
                    <div class="section-content">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="team-member bg-white-fa maxwidth400">
                                    <div class="thumb"><img class="img-fullwidth"
                                            src="{{ asset('assets/images/team/2.jpg') }}" alt="">
                                        <div class="info bg-white p-15 pb-10 text-center">
                                            <h3 class="name m-0"><a href="#" class="text-theme-colored">Sakib
                                                    Smith</a></h3>
                                            <h5
                                                class="occupation font-13 font-weight-400 text-gray letter-space-1 line-bottom-centered mt-0">
                                                - Engine Specialist -</h5>
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="team-member bg-white-fa maxwidth400">
                                    <div class="thumb"><img class="img-fullwidth"
                                            src="{{ asset('assets/images/team/3.jpg') }}" alt="">
                                        <div class="info bg-white p-15 pb-10 text-center">
                                            <h3 class="name m-0"><a href="#" class="text-theme-colored">Andrew
                                                    Smith</a></h3>
                                            <h5
                                                class="occupation font-13 font-weight-400 text-gray letter-space-1 line-bottom-centered mt-0">
                                                - Engine Specialist -</h5>
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="team-member bg-white-fa maxwidth400">
                                    <div class="thumb"><img class="img-fullwidth"
                                            src="{{ asset('assets/images/team/4.jpg') }}" alt="">
                                        <div class="info bg-white p-15 pb-10 text-center">
                                            <h3 class="name m-0"><a href="#" class="text-theme-colored">Jorden
                                                    Smith</a></h3>
                                            <h5
                                                class="occupation font-13 font-weight-400 text-gray letter-space-1 line-bottom-centered mt-0">
                                                - Engine Specialist -</h5>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="portfolio-filter">
                                    ...
                                    <a href="#wheel" class="" data-filter=".wheel">Wheel & Tire</a>
                                    <a href="#oil" class="" data-filter=".oil">Oil</a>
                                    <a href="#engine" class="" data-filter=".engine">Engine</a>
                                    <a href="#brake" class="" data-filter=".brake">Brake</a>
                                </div>
                                <!-- End Works Filter -->
                                ...
                                <div id="grid" class="gallery-isotope grid-4 gutter clearfix">
                                    ...
                                    <div class="gallery-item wheel">
                                        <div class="work-gallery">
                                            <div class="gallery-thumb">
                                                <img class="img-fullwidth" alt=""
                                                    src="{{ asset('assets/images/works/7.jpg') }}">
                                                <div class="gallery-overlay"></div>
                                                <div class="gallery-contect">
                                                    <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                        <li><a href="#"><i class="fa fa-link"></i></a></li>
                                                        <li><a data-rel="prettyPhoto"
                                                                href="{{ asset('assets/images/works/7.jpg') }}"><i
                                                                    class="fa fa-arrows"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="gallery-item wheel">
                                        <div class="work-gallery">
                                            <div class="gallery-thumb">
                                                <img class="img-fullwidth" alt=""
                                                    src="{{ asset('assets/images/works/16.jpg') }}">
                                                <div class="gallery-overlay"></div>
                                                <div class="gallery-contect">
                                                    <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                        <li><a href="#"><i class="fa fa-link"></i></a></li>
                                                        <li><a data-rel="prettyPhoto"
                                                                href="{{ asset('assets/images/works/16.jpg') }}"><i
                                                                    class="fa fa-arrows"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="gallery-item oil">
                                        <div class="work-gallery">
                                            <div class="gallery-thumb">
                                                <img class="img-fullwidth" alt=""
                                                    src="{{ asset('assets/images/works/3.jpg') }}">
                                                <div class="gallery-overlay"></div>
                                                <div class="gallery-contect">
                                                    <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                        <li><a href="#"><i class="fa fa-link"></i></a></li>
                                                        <li><a data-rel="prettyPhoto"
                                                                href="{{ asset('assets/images/works/3.jpg') }}"><i
                                                                    class="fa fa-arrows"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="gallery-item oil">
                                        <div class="work-gallery">
                                            <div class="gallery-thumb">
                                                <img class="img-fullwidth" alt=""
                                                    src="{{ asset('assets/images/works/13.jpg') }}">
                                                <div class="gallery-overlay"></div>
                                                <div class="gallery-contect">
                                                    <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                        <li><a href="#"><i class="fa fa-link"></i></a></li>
                                                        <li><a data-rel="prettyPhoto"
                                                                href="{{ asset('assets/images/works/13.jpg') }}"><i
                                                                    class="fa fa-arrows"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="gallery-item oil">
                                        <div class="work-gallery">
                                            <div class="gallery-thumb">
                                                <img class="img-fullwidth" alt=""
                                                    src="{{ asset('assets/images/works/14.jpg') }}">
                                                <div class="gallery-overlay"></div>
                                                <div class="gallery-contect">
                                                    <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                        <li><a href="#"><i class="fa fa-link"></i></a></li>
                                                        <li><a data-rel="prettyPhoto"
                                                                href="{{ asset('assets/images/works/14.jpg') }}"><i
                                                                    class="fa fa-arrows"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <!-- Portfolio Item Start -->
                                    <div class="gallery-item engine">
                                        <div class="work-gallery">
                                            <div class="gallery-thumb">
                                                <img class="img-fullwidth" alt=""
                                                    src="{{ asset('assets/images/works/2.jpg') }}">
                                                <div class="gallery-overlay"></div>
                                                <div class="gallery-contect">
                                                    <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                        <li><a href="#"><i class="fa fa-link"></i></a></li>
                                                        <li><a data-rel="prettyPhoto"
                                                                href="{{ asset('assets/images/works/2.jpg') }}"><i
                                                                    class="fa fa-arrows"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="gallery-item engine">
                                        <div class="work-gallery">
                                            <div class="gallery-thumb">
                                                <img class="img-fullwidth" alt=""
                                                    src="{{ asset('assets/images/works/9.jpg') }}">
                                                <div class="gallery-overlay"></div>
                                                <div class="gallery-contect">
                                                    <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                        <li><a href="#"><i class="fa fa-link"></i></a></li>
                                                        <li><a data-rel="prettyPhoto"
                                                                href="{{ asset('assets/images/works/9.jpg') }}"><i
                                                                    class="fa fa-arrows"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="gallery-item engine">
                                        <div class="work-gallery">
                                            <div class="gallery-thumb">
                                                <img class="img-fullwidth" alt=""
                                                    src="{{ asset('assets/images/works/10.jpg') }}">
                                                <div class="gallery-overlay"></div>
                                                <div class="gallery-contect">
                                                    <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                        <li><a href="#"><i class="fa fa-link"></i></a></li>
                                                        <li><a data-rel="prettyPhoto"
                                                                href="{{ asset('assets/images/works/10.jpg') }}"><i
                                                                    class="fa fa-arrows"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <!-- Portfolio Item Start -->
                                    <div class="gallery-item brake">
                                        <div class="work-gallery">
                                            <div class="gallery-thumb">
                                                <img class="img-fullwidth" alt=""
                                                    src="{{ asset('assets/images/works/8.jpg') }}">
                                                <div class="gallery-overlay"></div>
                                                <div class="gallery-contect">
                                                    <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                        <li><a href="#"><i class="fa fa-link"></i></a></li>
                                                        <li><a data-rel="prettyPhoto"
                                                                href="{{ asset('assets/images/works/8.jpg') }}"><i
                                                                    class="fa fa-arrows"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="gallery-item brake">
                                        <div class="work-gallery">
                                            <div class="gallery-thumb">
                                                <img class="img-fullwidth" alt=""
                                                    src="{{ asset('assets/images/works/12.jpg') }}">
                                                <div class="gallery-overlay"></div>
                                                <div class="gallery-contect">
                                                    <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                        <li><a href="#"><i class="fa fa-link"></i></a></li>
                                                        <li><a data-rel="prettyPhoto"
                                                                href="{{ asset('assets/images/works/12.jpg') }}"><i
                                                                    class="fa fa-arrows"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="gallery-item brake">
                                        <div class="work-gallery">
                                            <div class="gallery-thumb">
                                                <img class="img-fullwidth" alt=""
                                                    src="{{ asset('assets/images/works/15.jpg') }}">
                                                <div class="gallery-overlay"></div>
                                                <div class="gallery-contect">
                                                    <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                        <li><a href="#"><i class="fa fa-link"></i></a></li>
                                                        <li><a data-rel="prettyPhoto"
                                                                href="{{ asset('assets/images/works/15.jpg') }}"><i
                                                                    class="fa fa-arrows"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                ...
                <div class="container pt-60 pb-60">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h2 class="line-bottom-center text-gray-lightgray text-center mt-0 mb-30">Our Happy Clients
                                say</h2>
                                ...
                                <div class="item">
                                    <div class="testimonial-wrapper text-center">
                                        ...
                                        <div class="content pt-10">
                                            <p class="font-15 text-white"><em>Lorem ipsum dolor sit amet, consectetur
                                                    adipisicing elit. Neque est quasi, quas ipsam, expedita placeat
                                                    facilis odio illo ex accusantium eaque itaque officiis et sit. Vero
                                                    quo, impedit neque.</em></p>
                        ...
                        <div class="col-md-7">
                            <div class="p-40 pt-60 pl-0">
                                ...
                                <form id="reservation_form" name="reservation_form" class="reservation-form"
                                    method="post"
                                    action="http://html.kodesolution.live/s/workshop/v3.0/demo/includes/reservation.php">
                                    <h3 class="mt-0 line-bottom text-theme-colored mb-40">Get A Free Service<span
                                            class="text-theme-color-2 font-weight-600"> Now!</span></h3>
                                    <div class="row">
                                        <div class="col-sm-12">
            ...
            <section id="blog">
                <div class="container">
                    <div class="section-content">
                        <div class="row">
                            <div class="col-md-12">
                                <h3 class="text-uppercase text-theme-colored title line-bottom line-height-1 mt-0">
                                    Latest <span class="text-theme-color-2 font-weight-400">News</span></h3>
                                        ...
                                        <article class="post clearfix bg-lighter">
                                            ...
                                            <div class="entry-content p-15 pt-10 pb-10">
                                                ...
                                                <p class="mt-5">Lorem ipsum dolor sit amet, consectetur
                                                    adipisi cing elit. Molestias eius illum libero dolor nobis
                                                    deleniti<a class="text-theme-color-2 font-12 ml-5"
                                    ...
                                    <div class="item">
                                        <article class="post clearfix bg-lighter">
                                            ...
                                            <div class="entry-content p-15 pt-10 pb-10">
                                                ...
                                                <p class="mt-5">Lorem ipsum dolor sit amet, consectetur
                                                    adipisi cing elit. Molestias eius illum libero dolor nobis
                                                    deleniti<a class="text-theme-color-2 font-12 ml-5" href="#"> View
                                                        Details</a></p>
                                            </div>
                                        </article>
                                    </div>
