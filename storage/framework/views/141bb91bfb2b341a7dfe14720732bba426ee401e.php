...
<body class="">
    <div id="wrapper" class="clearfix">
                        ...
                        <div class="col-md-8">
                            <div class="widget no-border m-0 mr-15 mr-sm-0 pull-right flip sm-pull-none sm-text-center">
                                <ul class="styled-icons icon-circled icon-sm">
                                    <li><a href="<?php echo e(env('APP_FACEBOOK')); ?>"><i
                                                class="fa fa-facebook text-white"></i></a></li>
                                    <li><a href="<?php echo e(env('APP_TWITTER')); ?>"><i
                                                class="fa fa-twitter text-white"></i></a></li>
                                    <li><a href="<?php echo e(env('APP_INSTAGRAME')); ?>"><i
                            ...
                            <div class="widget no-border m-0">
                                <a href="<?php echo e(route('index')); ?>"
                                    class="menuzord-brand pull-left flip xs-pull-center mt-10 mb-10"><img alt=""
                                        src="<?php echo e(asset('assets/images/logo-wide.png')); ?>"></a>
                            </div>
                        </div>
                            ...
                            <div class="widget no-border pull-right sm-pull-none sm-text-center mt-10 mb-10 m-0">
                                <ul class="list-inline">
                                    ...
                                    <li>
                                        ...
                                        <h5 class="font-14 m-0"> <?php echo e(env('APP_PHONE')); ?></h5>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="widget no-border pull-right sm-pull-none sm-text-center mt-10 mb-10 m-0">
                                <ul class="list-inline">
                                    ...
                                    <li>
                                        ...
                                        <h5 class="font-13 text-black m-0"> <?php echo e(env('APP_TIME')); ?></h5>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <nav id="menuzord" class="menuzord bg-theme-colored pull-left flip menuzord-responsive">
                            <ul class="menuzord-menu">
                                ...
                                <li><a
                                        href="https://web.whatsapp.com/send?phone=<?php echo e(env('APP_WHATSAPP')); ?>">Whatsapp</a>
                                </li>
                            </ul>
                            <ul class="pull-right flip hidden-sm hidden-xs">
                                <li>
                                    ...
                                    <a class="btn btn-colored btn-flat bg-theme-color-2 text-white font-14 mt-0 p-25 pr-15 pl-15"
                                        href="https://web.whatsapp.com/send?phone=<?php echo e(env('APP_WHATSAPP')); ?>">Book
                                        Now</a>
                                    <!-- Modal: Book Now End -->
                                </li>
                            </ul>
        ...
        <footer id="footer" class="footer divider layer-overlay overlay-dark-8"
            data-bg-img="<?php echo e(asset('assets/images/bg/bg6.jpg')); ?>">
            <div class="container pt-70 pb-40">
                <div class="row border-bottom">
                    <div class="col-sm-6 col-md-3">
                        <div class="widget dark">
                            <img class="mt-5 mb-20" alt=""
                                src="<?php echo e(asset('assets/images/logo-white-footer.png')); ?>">
            ...
            <div class="footer-bottom bg-black-333">
                <div class="container pt-20 pb-20">
                    <div class="row">
                        <div class="col-md-6">
                            <p class="font-11 text-black-777 m-0">Copyright &copy;<?php echo e(date('Y')); ?>

                                <?php echo e(env('APP_NAME')); ?>. All Rights Reserved
                            </p>
                        </div>
                        <div class="col-md-6 text-right">
                            <div class="widget no-border m-0">
    ...
    <script type="text/javascript"
        src="<?php echo e(asset('assets/js/revolution-slider/js/extensions/revolution.extension.layeranimation.min.js')); ?>">
    </script>
    <script type="text/javascript"
...
<?php /**PATH C:\xampp\htdocs\flexcar\resources\views/landing/layout/app.blade.php ENDPATH**/ ?>