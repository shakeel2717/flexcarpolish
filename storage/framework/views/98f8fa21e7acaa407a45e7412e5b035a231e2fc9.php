            ...
            <div class="rev_slider" data-version="5.0">
                <ul>
                    ...
                    <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default"
                        ...
                        data-thumb="<?php echo e(asset('assets/images/stock/clean_left_mirror.jpg')); ?>" data-rotate="0"
                        data-saveperformance="off" data-title="Slide 1" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="<?php echo e(asset('assets/images/stock/clean_left_mirror.jpg')); ?>" alt=""
                        ...
                        <div class="tp-caption tp-resizeme" id="rs-1-layer-4" data-x="['left']" data-hoffset="['35']"
                            ...
                            style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a
                                ...
                                href="https://web.whatsapp.com/send?phone=<?php echo e(env('APP_WHATSAPP')); ?>">Book now</a>
                        </div>
                    </li>
                    ...
                    <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default"
                        data-easein="default" data-easeout="default" data-masterspeed="default"
                        data-thumb="<?php echo e(asset('assets/images/stock/headlight_wash.jpg')); ?>" data-rotate="0"
                        data-saveperformance="off" data-title="Slide 2" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="<?php echo e(asset('assets/images/stock/headlight_wash.jpg')); ?>" alt=""
                    ...
                    <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default"
                        data-easein="default" data-easeout="default" data-masterspeed="default"
                        data-thumb="<?php echo e(asset('assets/images/stock/clean_back_mirror.jpg')); ?>" data-rotate="0"
                        data-saveperformance="off" data-title="Slide 3" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="<?php echo e(asset('assets/images/stock/clean_back_mirror.jpg')); ?>" alt=""
                ...
                $(".rev_slider").revolution({
                    ...
                    navigation: {
                        ...
                        bullets: {
                            ...
                            v_offset: 30,
                            space: 5,
                            tmp: '<span class="tp-bullet-img-wrap">  <span class="tp-bullet-image"></span></span><span class="tp-bullet-title"><?php echo e(env('APP_NAME')); ?></span>'
                        }
                    },
...
<?php /**PATH C:\xampp\htdocs\flexcar\resources\views/inc/slider.blade.php ENDPATH**/ ?>