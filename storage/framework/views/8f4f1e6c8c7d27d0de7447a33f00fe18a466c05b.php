            ...
            <div class="section-content">
                <div class="row">
                    <div class="col-sm-6 col-md-4 maxwidth500 mb-sm-40 wow fadeInUp" data-margin-top="-80px"
                        ...
                        <img class="img-fullwidth" src="<?php echo e(asset('assets/images/stock/full_car_in.jpg')); ?>" alt="">
                        <div class="bg-lighter border-1px p-20 pt-0 mb-sm-180">
                            <h4 class="font-weight-700 mt-20">Experienced Service</h4>
                            <p><?php echo env('APP_DESC'); ?></p>
                            <a href="<?php echo e(route('contact')); ?>" class="btn btn-sm btn-theme-colored">Contact us</a>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-4 maxwidth500 mb-sm-40 wow fadeInUp" data-margin-top="-80px"
                        data-wow-duration="1s" data-wow-delay="0.1s">
                        <img class="img-fullwidth" src="<?php echo e(asset('assets/images/stock/clean_tire.jpg')); ?>" alt="">
                        <div class="bg-lighter border-1px p-20 pt-0 mb-sm-180">
                            <h4 class="font-weight-700 mt-20">Wheel & Tire Cleaning</h4>
                            <p><?php echo env('APP_DESC'); ?></p>
                            <a href="https://web.whatsapp.com/send?phone=<?php echo e(env('APP_WHATSAPP')); ?>"
                    ...
                    <div class="col-sm-6 col-md-4 maxwidth500 mb-sm-0 wow fadeInUp" data-margin-top="-80px"
                        data-wow-duration="1s" data-wow-delay="0.1s">
                        <img class="img-fullwidth" src="<?php echo e(asset('assets/images/stock/black_tire.jpg')); ?>" alt="">
                ...
                <div class="row">
                    <div class="col-md-6 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
                        <h2 class="text-uppercase mt-0 font-weight-600">Welcome To <span
                                class="text-theme-color-2"><?php echo e(env('APP_NAME')); ?></span><br> in Abu Dubai</h2>
                    ...
                    <div class="col-md-6 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
                        <div class="row mb-10">
                            <div class="col-md-12">
                                <img class="img-fullwidth" src="<?php echo e(asset('assets/images/stock/hero.jpg')); ?>" alt="">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 pr-5 pr-sm-15 mb-sm-10">
                                <img class="img-fullwidth" src="<?php echo e(asset('assets/images/stock/left_side_mirror.jpg')); ?>"
                                    alt="">
                            </div>
                            <div class="col-md-6 pl-5 pl-sm-15">
                                <img class="img-fullwidth" src="<?php echo e(asset('assets/images/stock/tire_air_clean.jpg')); ?>"
                                    alt="">
                            </div>
                        </div>
                    </div>
            ...
            <div class="section-content">
                <div class="row">
                    <div class="col-md-6 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
                        <div class="row mb-10">
                            <div class="col-md-12">
                                <img class="img-fullwidth" src="<?php echo e(asset('assets/images/stock/front_shower.jpg')); ?>"
                                    alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="icon-box p-10 pl-20 pr-15 mb-20 bg-white">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia quasi qui
                                inventore, cumque!<a href="https://web.whatsapp.com/send?phone=<?php echo e(env('APP_WHATSAPP')); ?>"
                        ...
                        <div id="grid" class="gallery-isotope grid-4 gutter clearfix">
                                ...
                                <div class="work-gallery">
                                    <div class="gallery-thumb">
                                        <img class="img-fullwidth" alt=""
                                            src="<?php echo e(asset('assets/images/stock/black_tire.jpg')); ?>">
                                        <div class="gallery-overlay"></div>
                                        <div class="gallery-contect">
                                            <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                <li><a data-rel="prettyPhoto"
                                                        href="<?php echo e(asset('assets/images/stock/black_tire.jpg')); ?>"><i
                            ...
                            <div class="gallery-item wheel">
                                <div class="work-gallery">
                                    <div class="gallery-thumb">
                                        <img class="img-fullwidth" alt=""
                                            src="<?php echo e(asset('assets/images/stock/clean_back_mirror.jpg')); ?>">
                                        <div class="gallery-overlay"></div>
                                        <div class="gallery-contect">
                                            <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                <li><a data-rel="prettyPhoto"
                                                        href="<?php echo e(asset('assets/images/stock/clean_back_mirror.jpg')); ?>"><i
                                                            class="fa fa-arrows"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="gallery-item wheel">
                                <div class="work-gallery">
                                    <div class="gallery-thumb">
                                        <img class="img-fullwidth" alt=""
                                            src="<?php echo e(asset('assets/images/stock/clean_front_mirror.jpg')); ?>">
                                        <div class="gallery-overlay"></div>
                                        <div class="gallery-contect">
                                            <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                <li><a data-rel="prettyPhoto"
                                                        href="<?php echo e(asset('assets/images/stock/clean_front_mirror.jpg')); ?>"><i
                                                            class="fa fa-arrows"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="gallery-item wheel">
                                <div class="work-gallery">
                                    <div class="gallery-thumb">
                                        <img class="img-fullwidth" alt=""
                                            src="<?php echo e(asset('assets/images/stock/clean_headlight.jpg')); ?>">
                                        <div class="gallery-overlay"></div>
                                        <div class="gallery-contect">
                                            <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                <li><a data-rel="prettyPhoto"
                                                        href="<?php echo e(asset('assets/images/stock/clean_headlight.jpg')); ?>"><i
                                                            class="fa fa-arrows"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="gallery-item wheel">
                                <div class="work-gallery">
                                    <div class="gallery-thumb">
                                        <img class="img-fullwidth" alt=""
                                            src="<?php echo e(asset('assets/images/stock/clean_left_mirror.jpg')); ?>">
                                        <div class="gallery-overlay"></div>
                                        <div class="gallery-contect">
                                            <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                <li><a data-rel="prettyPhoto"
                                                        href="<?php echo e(asset('assets/images/stock/clean_left_mirror.jpg')); ?>"><i
                                                            class="fa fa-arrows"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="gallery-item wheel">
                                <div class="work-gallery">
                                    <div class="gallery-thumb">
                                        <img class="img-fullwidth" alt=""
                                            src="<?php echo e(asset('assets/images/stock/clean_tire.jpg')); ?>">
                                        <div class="gallery-overlay"></div>
                                        <div class="gallery-contect">
                                            <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                <li><a data-rel="prettyPhoto"
                                                        href="<?php echo e(asset('assets/images/stock/clean_tire.jpg')); ?>"><i
                                                            class="fa fa-arrows"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="gallery-item wheel">
                                <div class="work-gallery">
                                    <div class="gallery-thumb">
                                        <img class="img-fullwidth" alt=""
                                            src="<?php echo e(asset('assets/images/stock/engine_clean.jpg')); ?>">
                                        <div class="gallery-overlay"></div>
                                        <div class="gallery-contect">
                                            <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                <li><a data-rel="prettyPhoto"
                                                        href="<?php echo e(asset('assets/images/stock/engine_clean.jpg')); ?>"><i
                                                            class="fa fa-arrows"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="gallery-item wheel">
                                <div class="work-gallery">
                                    <div class="gallery-thumb">
                                        <img class="img-fullwidth" alt=""
                                            src="<?php echo e(asset('assets/images/stock/front_shower.jpg')); ?>">
                                        <div class="gallery-overlay"></div>
                                        <div class="gallery-contect">
                                            <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                <li><a data-rel="prettyPhoto"
                                                        href="<?php echo e(asset('assets/images/stock/front_shower.jpg')); ?>"><i
                                                            class="fa fa-arrows"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="gallery-item wheel">
                                <div class="work-gallery">
                                    <div class="gallery-thumb">
                                        <img class="img-fullwidth" alt=""
                                            src="<?php echo e(asset('assets/images/stock/full_car_in.jpg')); ?>">
                                        <div class="gallery-overlay"></div>
                                        <div class="gallery-contect">
                                            <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                <li><a data-rel="prettyPhoto"
                                                        href="<?php echo e(asset('assets/images/stock/full_car_in.jpg')); ?>"><i
                                                            class="fa fa-arrows"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="gallery-item wheel">
                                <div class="work-gallery">
                                    <div class="gallery-thumb">
                                        <img class="img-fullwidth" alt=""
                                            src="<?php echo e(asset('assets/images/stock/headlight_wash.jpg')); ?>">
                                        <div class="gallery-overlay"></div>
                                        <div class="gallery-contect">
                                            <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                <li><a data-rel="prettyPhoto"
                                                        href="<?php echo e(asset('assets/images/stock/headlight_wash.jpg')); ?>"><i
                                                            class="fa fa-arrows"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="gallery-item wheel">
                                <div class="work-gallery">
                                    <div class="gallery-thumb">
                                        <img class="img-fullwidth" alt=""
                                            src="<?php echo e(asset('assets/images/stock/inside_clean.jpg')); ?>">
                                        <div class="gallery-overlay"></div>
                                        <div class="gallery-contect">
                                            <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                <li><a data-rel="prettyPhoto"
                                                        href="<?php echo e(asset('assets/images/stock/inside_clean.jpg')); ?>"><i
                                                            class="fa fa-arrows"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="gallery-item wheel">
                                <div class="work-gallery">
                                    <div class="gallery-thumb">
                                        <img class="img-fullwidth" alt=""
                                            src="<?php echo e(asset('assets/images/stock/left_side_mirror.jpg')); ?>">
                                        <div class="gallery-overlay"></div>
                                        <div class="gallery-contect">
                                            <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                <li><a data-rel="prettyPhoto"
                                                        href="<?php echo e(asset('assets/images/stock/left_side_mirror.jpg')); ?>"><i
                                                            class="fa fa-arrows"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="gallery-item wheel">
                                <div class="work-gallery">
                                    <div class="gallery-thumb">
                                        <img class="img-fullwidth" alt=""
                                            src="<?php echo e(asset('assets/images/stock/seat_clean.jpg')); ?>">
                                        <div class="gallery-overlay"></div>
                                        <div class="gallery-contect">
                                            <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                <li><a data-rel="prettyPhoto"
                                                        href="<?php echo e(asset('assets/images/stock/seat_clean.jpg')); ?>"><i
                                                            class="fa fa-arrows"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="gallery-item wheel">
                                <div class="work-gallery">
                                    <div class="gallery-thumb">
                                        <img class="img-fullwidth" alt=""
                                            src="<?php echo e(asset('assets/images/stock/tire_air_clean.jpg')); ?>">
                                        <div class="gallery-overlay"></div>
                                        <div class="gallery-contect">
                                            <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                <li><a data-rel="prettyPhoto"
                                                        href="<?php echo e(asset('assets/images/stock/tire_air_clean.jpg')); ?>"><i
                                                            class="fa fa-arrows"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
    ...
    <section class="">
        <div class="container">
            <div class="section-content">
                <div class="row">
                    <div class="col-md-6">
                        <img alt="" src="<?php echo e(asset('assets/images/stock/hero2.jpg')); ?>" class="img-fullwidth">
                        ...
                        <div class="row">
                            <div class="col-xs-4 sm-text-center mb-sm-30">
                                <a class="image-popup-vertical-fit" title="Title Here 1"
                                    href="<?php echo e(asset('assets/images/stock/clean_tire.jpg')); ?>"><img
                                        class="img-fullwidth maxwidth500"
                                        src="<?php echo e(asset('assets/images/stock/clean_tire.jpg')); ?>" alt=""></a>
                            </div>
                            <div class="col-xs-4 sm-text-center mb-sm-30">
                                <a class="image-popup-vertical-fit" title="Title Here 1"
                                    href="<?php echo e(asset('assets/images/stock/headlight_wash.jpg')); ?>"><img
                                        class="img-fullwidth maxwidth500"
                                        src="<?php echo e(asset('assets/images/stock/headlight_wash.jpg')); ?>" alt=""></a>
                            </div>
                            <div class="col-xs-4 sm-text-center">
                                <a class="image-popup-vertical-fit" title="Title Here 1"
                                    href="<?php echo e(asset('assets/images/about/lg1.jpg')); ?>"><img
                                        class="img-fullwidth maxwidth500"
                                        src="<?php echo e(asset('assets/images/about/lg1.jpg')); ?>" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-item-end">
                <div class="col-md-6">
                    <div class="p-40 pt-60 pl-0">
                        ...
                        <form class="reservation-form" method="post" action="<?php echo e(route('contactForm')); ?>">
                            <?php echo csrf_field(); ?>
                ...
                <div class="col-md-6">
                    <img src="<?php echo e(asset('assets/images/stock/bonut.jpg')); ?>" alt="">
                </div>
            </div>
        </div>
    </section>
